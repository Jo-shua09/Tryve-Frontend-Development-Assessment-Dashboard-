const Newuser = () => {
  return (
    <div className="sm:flex-[4] mx-5 pt-3">
      <h1 className="text-4xl mb-10 font-bold">new user</h1>
      <form className="grid sm:grid-cols-2 grid-cols-1 gap-y-5 justify-between gap-x-20 w-full h-full">
        <div className="flex flex-col gap-y-2 w-full">
          ...
          <input
            type="text"
            className="border text-xl rounded-md pl-2 text-black h-16 w-full"
        ...
        <div className=" flex flex-col items-start w-fit gap-x-3">
          <label className="text-2xl font-semibold"> active:</label>
          <select
            name="active"
            id="active"
            className="border w-full h-16 text-xl px-3 capitalize font-medium rounded-md p-2"
          >
        ...
        <button className="w-52 bg-blue-700 h-16 font-bold text-white text-xl rounded-lg capitalize sm:mt-10 mt-5 mb-5">
          create
        </button>
      </form>
    </div>

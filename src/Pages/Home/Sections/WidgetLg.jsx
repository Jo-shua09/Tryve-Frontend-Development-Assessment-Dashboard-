import { transactions } from "../../../Services/DummyData";
...
const WidgetLg = () => {
  const Button = ({ type }) => {
    ...
    return (
      <button
        className={`px-6 py-3 rounded-lg text-2xl ${backgroundColorClass} ${textColorClass}`}
      >
        {type}
      </button>
    );
  ...
  return (
    <div className=" w-full md:flex-[2] shadow-[1px_1px_5px_rgba(0,0,0,0.2)] p-5">

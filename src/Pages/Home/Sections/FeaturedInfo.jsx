...
const FeaturedInfo = () => {
  return (
    <div className="w-full flex justify-between flex-wrap gap-10 sm:flex-nowrap">
      <div className=" w-full sm:flex-1 p-7 rounded-xl shadow-[1px_1px_5px_rgba(0,0,0,0.2)]">
        ...
        <span className="text-xl text-gray-400 normal-case">
